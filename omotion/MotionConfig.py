...
class MotionConfig:
    ...
    def __init__(self, header: Optional[MotionConfigHeader] = None, json_data: Optional[Dict[str, Any]] = None):
        """
        ...
        """
        self.header = header if header else MotionConfigHeader(
            magic=MOTION_MAGIC,
            version=MOTION_VER,
            seq=0,
            crc=0,
    ...
    def __repr__(self) -> str:
        return (f"MotionConfig(seq={self.header.seq}, crc=0x{self.header.crc:04X}, "
