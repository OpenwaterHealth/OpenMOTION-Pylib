...
class MOTIONSensor:
    ...
    def set_fan_control(self, fan_on: bool) -> bool:
        ...
        try:
            ...
            r = self.uart.comm.send_packet(id=None, packetType=OW_CONTROLLER, command=OW_CMD_FAN_CTL, reserved=reserved)
            self.uart.comm.clear_buffer()
    ...
    def get_fan_control_status(self) -> bool:
        ...
        try:
            ...
            r = self.uart.comm.send_packet(id=None, packetType=OW_CONTROLLER, command=OW_CMD_FAN_CTL, reserved=0x00)
            self.uart.comm.clear_buffer()
