    ...
    def set_debug_flags(self, flags: int) -> bool:
        ...
        try:
            ...
            r = self.uart.comm.send_packet(
                id=None,
                packetType=OW_CMD,
                command=OW_CMD_SET_DEBUG_FLAGS,
                data=flags_bytes
            )
            self.uart.comm.clear_buffer()
    ...
    def get_debug_flags(self) -> int:
        ...
        try:
            ...
            r = self.uart.comm.send_packet(
                id=None,
                packetType=OW_CMD,
                command=OW_CMD_GET_DEBUG_FLAGS
            )
            self.uart.comm.clear_buffer()
