...
Note: contrast_raw is intentionally NOT computed here. The valid speckle
contrast definition uses a corrected mean, but MomentsStage has no dark or
pedestal correction. Contrast is computed downstream by
