"""WI-00015 Device Specific Parameter Tuning - automated runner.
...
def main() -> int:
    ...
    p = sub.add_parser("baseline"); p.add_argument("--side", required=True,
                                                   choices=["left", "right"])
    p = sub.add_parser("tune"); p.add_argument("--seated", required=True,
                                               choices=["left", "right"])
    p = sub.add_parser("crosscheck"); p.add_argument("--seated", required=True,
                                                     choices=["left", "right"])
    sub.add_parser("finalize")
    p = sub.add_parser("diagnose-low"); p.add_argument("--seated", required=True,
                                                       choices=["left", "right"])
